...
This guide defines the supported high-availability behavior of BS9 1.6.14. It distinguishes automatic, zero-code process availability from application state that must use an explicit shared-state mechanism.
