...
- Previous Git tag: `v1.6.5`
- Planned tag for this release: `v1.6.6`
...
- Patch (`1.6.6` to `1.6.7`): compatible fixes and documentation corrections.
...
```bash
git add --all
git commit -m "release: bs9 v1.6.6"
git tag -a v1.6.6 -m "BS9 v1.6.6"
