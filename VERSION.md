...
- Previous Git tag: `v1.6.12`
- Planned tag for this release: `v1.6.13`
...
- Patch (`1.6.12` to `1.6.13`): compatible fixes and documentation corrections.
...
```bash
git add --all
git commit -m "release: bs9 v1.6.13"
git tag -a v1.6.13 -m "BS9 v1.6.13"
