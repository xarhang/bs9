...
- Source version: **1.6.11**
- Release date: **September 19, 2026**
- License: **GNU Affero General Public License v3.0 or later (`AGPL-3.0-or-later`)**
- Previous Git tag: `v1.6.10`
- Planned tag for this release: `v1.6.11`
...
- Patch (`1.6.10` to `1.6.11`): compatible fixes and documentation corrections.
...
```bash
git add --all
git commit -m "release: bs9 v1.6.11"
git tag -a v1.6.11 -m "BS9 v1.6.11"
