...
- Previous Git tag: `v1.6.4`
- Planned tag for this release: `v1.6.5`
...
- Patch (`1.6.5` to `1.6.6`): compatible fixes and documentation corrections.
...
```bash
git add --all
git commit -m "release: bs9 v1.6.5"
git tag -a v1.6.5 -m "BS9 v1.6.5"
