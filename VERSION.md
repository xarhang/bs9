...
- Previous Git tag: `v1.6.3`
- Planned tag for this release: `v1.6.4`
...
- Patch (`1.6.4` to `1.6.5`): compatible fixes and documentation corrections.
...
```bash
git add --all
git commit -m "release: bs9 v1.6.4"
git tag -a v1.6.4 -m "BS9 v1.6.4"
